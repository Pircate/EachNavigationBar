...
extension UIViewController {
    ...
    @available(swift, deprecated: 4.0, message: "Please use navigation.bar")
    @objc public var each_navigationBar: EachNavigationBar {
        return _navigationBar
    }
    
    @available(swift, deprecated: 4.0, message: "Please use navigation.item")
    @objc public var each_navigationItem: UINavigationItem {
        return _navigationItem
    }
    
    @available(swift, deprecated: 4.0, message: "Please use setupNavigationBar")
